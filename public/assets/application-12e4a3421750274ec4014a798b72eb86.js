...
$(window).load(function() {
    ...
    try {
        $('#reg-form-inn').mask("999999999999");
    } catch (e) {}

    $('#reg-form-inn').removeClass('type').val($('#reg-form-inn').attr('default'));
    $('#reg-form-inn').blur(function() {
        if ($(this).val().length < 12)
            $(this).removeClass('type').val($(this).attr('default'));
    })
    //Проверка валидности email на лету
    $('#reg-form-email').bind('keydown', function (e) {

        if (e.which != 173 && e.which != 189 && e.which != 65 && e.which != 66 && e.which != 67 && e.which != 68 && e.which != 69 && e.which != 70 && e.which != 71 && e.which != 72 && e.which != 73 && e.which != 74 && e.which != 75 && e.which != 76 && e.which != 77 && e.which != 78 && e.which != 79 && e.which != 80 && e.which != 81 && e.which != 82 && e.which != 83 && e.which != 84 && e.which != 85 && e.which != 86 && e.which != 87 && e.which != 88 && e.which != 90 && e.which != 8 && e.which != 190 && e.which != 89 && e.which != 91 && e.which != 220 && e.which != 222 && e.which != 186 && e.which != 188 && e.which != 49 && e.which != 50 && e.which != 51 && e.which != 52 && e.which != 53 && e.which != 54 && e.which != 55 && e.which != 56 && e.which != 57 && e.which != 48 && e.which != 189 && e.which != 16 && e.which != 37 && e.which != 17 && e.which != 191 && e.which != 38 && e.which != 39 && e.which != 40 && e.which != 9 && e.which != 220 && e.which != 222 && e.which != 186 && e.which != 190 && e.which != 191 && e.which != 188 && e.which != 91) {
            return false;
        }
    ...
    $('#reg-form-email').blur(function() {
        ...
        if (!regularEmail.test(address)) {
            $('#err-reg-form-email').html('E-mail адрес указан не верно').show();
            return false;
        } else {
            $('#err-reg-form-email').html('').hide();
        }
    });

    //Проверка инупта ФИО (пишем слова с заглавной буквы + не выводим цифры)
    var prevCharacter = 32;
    $('#reg-form-person,.username').bind('keydown', function (e) {
        if (e.which == 48 || e.which == 49 || e.which == 50 || e.which == 51 || e.which == 52 || e.which == 53 || e.which == 54 || e.which == 55 || e.which == 56 || e.which == 57 || e.which == 96 || e.which == 97 || e.which == 98 || e.which == 99 || e.which == 100 || e.which == 101 || e.which == 102 || e.which == 103 || e.which == 104 || e.which == 105 || e.which == 189 || e.which == 187 || e.which == 191 || e.which == 221 || e.which == 222 || e.which == 186 || e.which == 188 || e.which == 190 || e.which == 192)
            return false;
    })
    $('#reg-form-person,.username').bind('keyup', function (e) {
        var newVal = [];
        if (e.which != 32) {
            var str = $(this).val();
            var arr = str.split(" ");
    ...
    try {
        $('#reg-form-opt-inn').mask("999999999999");
    } catch (e) {}

    $('#reg-form-opt-inn').removeClass('type').val($('#reg-form-opt-inn').attr('default'));
    $('#reg-form-opt-inn').blur(function() {
        if ($(this).val().length < 12)
            $(this).removeClass('type').val($(this).attr('default'));
    })
    //Проверка валидности email на лету
    $('#reg-form-opt-email').bind('keydown', function (e) {

        if (e.which != 65 && e.which != 66 && e.which != 67 && e.which != 68 && e.which != 69 && e.which != 70 && e.which != 71 && e.which != 72 && e.which != 73 && e.which != 74 && e.which != 75 && e.which != 76 && e.which != 77 && e.which != 78 && e.which != 79 && e.which != 80 && e.which != 81 && e.which != 82 && e.which != 83 && e.which != 84 && e.which != 85 && e.which != 86 && e.which != 87 && e.which != 88 && e.which != 90 && e.which != 8 && e.which != 190 && e.which != 89 && e.which != 91 && e.which != 220 && e.which != 222 && e.which != 186 && e.which != 188 && e.which != 49 && e.which != 50 && e.which != 51 && e.which != 52 && e.which != 53 && e.which != 54 && e.which != 55 && e.which != 56 && e.which != 57 && e.which != 48 && e.which != 189 && e.which != 16 && e.which != 37 && e.which != 17 && e.which != 191 && e.which != 38 && e.which != 39 && e.which != 40 && e.which != 9 && e.which != 220 && e.which != 222 && e.which != 186 && e.which != 190 && e.which != 191 && e.which != 188 && e.which != 91) {
            return false;
        }

    });
    $('#reg-form-opt-email').blur(function() {
        var regularEmail = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
        address = $(this).val();
        if (!regularEmail.test(address)) {
            $('#err-reg-form-email').html('E-mail адрес указан не верно').show();
    ...
    //Проверка инупта ФИО (пишем слова с заглавной буквы + не выводим цифры)
    var prevCharacter = 32;
    $('#reg-form-opt-person,.username').bind('keydown', function (e) {
        if (e.which == 48 || e.which == 49 || e.which == 50 || e.which == 51 || e.which == 52 || e.which == 53 || e.which == 54 || e.which == 55 || e.which == 56 || e.which == 57 || e.which == 96 || e.which == 97 || e.which == 98 || e.which == 99 || e.which == 100 || e.which == 101 || e.which == 102 || e.which == 103 || e.which == 104 || e.which == 105 || e.which == 189 || e.which == 187)
            return false;
    })
    $('#reg-form-opt-person,.username').bind('keyup', function (e) {
        var newVal = [];
        if (e.which != 32) {
            var str = $(this).val();
            var arr = str.split(" ");
    ...
    //Маска для сайта
    //Дописываем в инупт www.
    /*$('#reg-form-org_site').focus(function(){
    			if($(this).val().length < 4)
    				$(this).val('www.'+$(this).val());
    		});
    		$('#reg-form-org_site').blur(function(){
    			if($(this).val()=='www.')
    				$(this).val($(this).attr('default')).removeClass('type');
    		});
    		//Если пользователь начинает стирать, то снова пишем www.
    		$('#reg-form-org_site').bind('keyup', function(){
    			if($(this).val().length < 4) {
    				$(this).val('www.');
    			}
    		});
    		//Если жмет пробел, то не выводим его
    		$('#reg-form-org_site').bind('keydown', function(e){
    			if(e.which != 8 && e.which != 81 && e.which != 87 && e.which != 69 && e.which != 82 && e.which != 84 && e.which != 89 && e.which != 85 && e.which != 73 && e.which != 79 && e.which != 80 && e.which != 76 && e.which != 75 && e.which != 74 && e.which != 72 && e.which != 71 && e.which != 70 && e.which != 68 && e.which != 83 && e.which != 65 && e.which != 90 && e.which != 88 && e.which != 67 && e.which != 86 && e.which != 66 && e.which != 78 && e.which != 77 && e.which != 188 && e.which != 190 && e.which != 222 && e.which != 220 && e.which != 186 && e.which != 80 && e.which != 219 && e.which != 48 && e.which != 57 && e.which != 56 && e.which != 55 && e.which != 54 && e.which != 53 && e.which != 52 && e.which != 51 && e.which != 50 && e.which != 49 && e.which != 189 && e.which != 189 && e.which != 91 && e.which != 191 && e.which != 20 && e.which != 9) {
    				return false;
    			}
    		});
    */
    ...
    //Дописываем в инупт www.
    $('#corporate-form-site').focus(function() {
        if ($(this).val().length < 4)
            $(this).val('www.' + $(this).val());
    });
    $('#corporate-form-site').blur(function() {
        if ($(this).val() == 'www.')
            $(this).val($(this).attr('default')).removeClass('type');
    });
    //Если пользователь начинает стирать, то снова пишем www.
    $('#corporate-form-site').bind('keyup', function() {
        if ($(this).val().length < 4) {
            $(this).val('www.');
        }
    });
    //Если жмет пробел, то не выводим его
    $('#corporate-form-site').bind('keydown', function(e) {
        if (e.which != 16 && e.which != 8 && e.which != 81 && e.which != 87 && e.which != 69 && e.which != 82 && e.which != 84 && e.which != 89 && e.which != 85 && e.which != 73 && e.which != 79 && e.which != 80 && e.which != 76 && e.which != 75 && e.which != 74 && e.which != 72 && e.which != 71 && e.which != 70 && e.which != 68 && e.which != 83 && e.which != 65 && e.which != 90 && e.which != 88 && e.which != 67 && e.which != 86 && e.which != 66 && e.which != 78 && e.which != 77 && e.which != 16 && e.which != 188 && e.which != 16 && e.which != 190 && e.which != 222 && e.which != 220 && e.which != 186 && e.which != 80 && e.which != 219 && e.which != 221 && e.which != 48 && e.which != 57 && e.which != 56 && e.which != 55 && e.which != 54 && e.which != 53 && e.which != 52 && e.which != 51 && e.which != 50 && e.which != 49 && e.which != 189 && e.which != 16 && e.which != 189 && e.which != 91 && e.which != 191 && e.which != 20) {
            return false;
        };
    });
    ...
    $('.actions_list li').bind('mouseenter', function() {
        $('.actions_list li.active').removeClass('active');
        $(this).addClass('active');
    });

    $('.actions_list li').bind('mouseleave', function() {
        $('.actions_list li.active').removeClass('active')
    });
    ...
    // Подсвечиваю кнопки
    $('.im_button').live('mouseover', function() {
        oldSrc = $(this).attr('src');
        newSrc = oldSrc.replace(/\.(gif|png)/, '_a.$1');
        $(this).attr('src', newSrc);
    });
    $('.im_button').live('mouseleave', function() {
        oldSrc = $(this).attr('src');
        newSrc = oldSrc.replace(/_a\.(gif|png)/, '.$1');
        $(this).attr('src', newSrc);
    });

    // Обнуляем поле поиска по клику на крестик
    $('.search_form img').bind('click', function() {
        $('.search_form input').attr('value', '');
    });

    // Обнуляем поле поиска, когда поставили в инпут
    $('.search_form input').bind('click', function() {
        //if($('.search_form input').hasClass('default')) {
        if ($('.search_form input').val() == 'Поиск по каталогу') {
            $('.search_form input').attr('value', '');
            $('.search_form input').removeClass('default')
        }
    });

    // Возвращаем дефолтное значение поля поиска если ниче не написали в него
    $('.search_form input').bind('focusout', function() {
        if ($('.search_form input').attr('value') == '' ) {
            $('.search_form input').attr('value', 'Поиск по каталогу');
            $('.search_form input').addClass('default')
        }
    });

    // Показываем полное меню рубрики каталога
    if ($('.cat_menu .main_h a').size() > 0) {
        $('.cat_menu .main_h a').bind('mouseover', function() {
            $('#full_' + $(this).attr('id')).show();
        });
        $('.full_menu').bind('mouseleave', function() {
            $(this).hide();
        });
    }

    // Показываем окно логина
    $('.show_w').bind('click', function() {
        $('.enter').addClass('show_p');
        return false;
    })
    // Скрываем окно логина
    $('.enter form').bind('mouseleave', function() {
        $('.enter').removeClass('show_p');
    });


    // форма поиска
    $('#s_form').submit(function() {
        if (!$('#sq').val() || $('#sq').val() == 'Поиск по каталогу...') {
            return false;
        }
        var route = new Array();
        if (top.window.location.href.indexOf('recipes') > 0) {
            route[route.length] = 'in/recipes';
        }
        route[route.length] = encodeURIComponent($('#sq').val());
        route = '/search/' + route.join('/');
    ...
    $('.overlay').bind('click', function() {
        if (cartState && !adding) {
            $('#cart_items').hide('blind', function() {
                cartState = false
            });
    ...
    //Отступ от футера
    $('.footerSpacer').css('height' , $('.footer').height() + 'px');
    $(window).bind('resize' , function() {
        var newWidth = $('.twitter_messages').css('width');
        $('.footerSpacer').css('height', $('.footer').height() + 'px');
        hoveredActions();
    });
});
